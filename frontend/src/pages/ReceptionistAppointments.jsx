...
import { FaCalendarCheck, FaSearch, FaClock, FaEnvelope, FaUser } from 'react-icons/fa';
...
const ReceptionistAppointments = () => {
    ...
    const getBadgeVariant = (status) => {
        ...
        return null; // custom for prechecked handled via classes
    };
    ...
    const handleSearch = async () => {
        if (!searchEmail.trim()) {
            Swal.fire({
                ...
                text: 'Please enter a doctor\'s email to search.',
        ...
        try {
            const res = await receptionistAPI.getDoctorUpcomingAppointments(searchEmail);
            
            setDoctorInfo({
                name: res.data.doctor_name,
                email: res.data.email,
                fee: res.data.appointment_fee
            });
                ...
                <div className="fade-in">
                    ...
                    <div className="text-center mb-5">
                        ...
                        <span className="kindred-pill mt-2" style={{ fontFamily: "'Inter', sans-serif", fontWeight: '500' }}>
                            <FaEnvelope style={{ color: 'var(--luna-mid)' }} /> {doctorInfo.email}
                        </span>
                    </div>
                    ...
                    {upcomingList.length > 0 ? (
                        ...
                        <div className="text-center py-5">
                            ...
                            <p style={{ fontFamily: "'Inter', sans-serif", color: '#78909C' }}>This doctor has a clear schedule for now.</p>
                        </div>
                    )}
                </div>
            )}
